layui.define('table',function (exports) {
        ...
        var html = '<div class="">\
                    <div class="">\
                      ...
                      <div class="'+MD2+'" style="text-align: center;">\
                        <div id="'+LEFT_BTN+index+'"  style="margin-bottom: 10px;"><button data-type="0" data-index="'+index+'" class="layui-btn layui-btn-xs left-btn-set '+DISABLED+' '+BTN_STLY+'"> <i class="layui-icon">&#xe602;</i></button></div>\
                        <div id="'+RIGHT_BTN+index+'" ><button data-type="1" data-index="'+index+'" class="layui-btn layui-btn-xs '+DISABLED+' '+BTN_STLY+'"> <i class="layui-icon">&#xe603;</i></button></div>\
                      </div>\
                      <div class="'+MD5+'">\
    ...
    function datas (type) {
        ...
        var d2 =  d[1].data;
        var _d = [];
        if(type==0&&d2.length>0){
          layer.msg('现阶段角色只能为1个')
          return false;
        }
